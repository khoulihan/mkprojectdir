...
def _parse_arguments():
    ...
    parser.add_argument("project_type", type=str, help="the type of project to create")
...
def _get_project_type_path(pt):
    ...
    config_path = xdg_config / 'mkprojectdir' / 'project_types'
...
def _main():
    ...
    try:
        try:
            pt_path = _get_project_type_path(args.project_type)
        except FileNotFoundError as e:
            print ("The specified project type does not exist")
            sys.exit(1)
